...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-1gbyywk");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-1dbbc0o"));
    			add_location(button, file$6, 6, 0, 113);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*style*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-1dbbc0o"))) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-1kc855z");
    			add_location(input0, file$5, 16, 8, 295);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-1kc855z");
    			add_location(label0, file$5, 17, 8, 404);
    			attr_dev(li0, "class", "svelte-1kc855z");
    			add_location(li0, file$5, 15, 4, 282);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-1kc855z");
    			add_location(input1, file$5, 20, 8, 459);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-1kc855z");
    			add_location(label1, file$5, 21, 8, 568);
    			attr_dev(li1, "class", "svelte-1kc855z");
    			add_location(li1, file$5, 19, 4, 446);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "name", "rating");
    			attr_dev(input2, "id", "num3");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-1kc855z");
    			add_location(input2, file$5, 24, 8, 623);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-1kc855z");
    			add_location(label2, file$5, 25, 8, 732);
    			attr_dev(li2, "class", "svelte-1kc855z");
    			add_location(li2, file$5, 23, 4, 610);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "name", "rating");
    			attr_dev(input3, "id", "num4");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-1kc855z");
    			add_location(input3, file$5, 28, 8, 787);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-1kc855z");
    			add_location(label3, file$5, 29, 8, 896);
    			attr_dev(li3, "class", "svelte-1kc855z");
    			add_location(li3, file$5, 27, 4, 774);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "name", "rating");
    			attr_dev(input4, "id", "num5");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-1kc855z");
    			add_location(input4, file$5, 32, 8, 951);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-1kc855z");
    			add_location(label4, file$5, 33, 8, 1060);
    			attr_dev(li4, "class", "svelte-1kc855z");
    			add_location(li4, file$5, 31, 4, 938);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "name", "rating");
    			attr_dev(input5, "id", "num6");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-1kc855z");
    			add_location(input5, file$5, 36, 8, 1115);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-1kc855z");
    			add_location(label5, file$5, 37, 8, 1224);
    			attr_dev(li5, "class", "svelte-1kc855z");
    			add_location(li5, file$5, 35, 4, 1102);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "name", "rating");
    			attr_dev(input6, "id", "num7");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-1kc855z");
    			add_location(input6, file$5, 40, 8, 1279);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-1kc855z");
    			add_location(label6, file$5, 41, 8, 1388);
    			attr_dev(li6, "class", "svelte-1kc855z");
    			add_location(li6, file$5, 39, 4, 1266);
    			...
    			attr_dev(input7, "class", "svelte-1kc855z");
    			add_location(input7, file$5, 44, 8, 1443);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-1kc855z");
    			add_location(label7, file$5, 45, 8, 1552);
    			attr_dev(li7, "class", "svelte-1kc855z");
    			add_location(li7, file$5, 43, 4, 1430);
    			...
    			attr_dev(input8, "class", "svelte-1kc855z");
    			add_location(input8, file$5, 48, 8, 1607);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-1kc855z");
    			add_location(label8, file$5, 49, 8, 1716);
    			attr_dev(li8, "class", "svelte-1kc855z");
    			add_location(li8, file$5, 47, 4, 1594);
    			...
    			attr_dev(input9, "class", "svelte-1kc855z");
    			add_location(input9, file$5, 52, 8, 1771);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-1kc855z");
    			add_location(label9, file$5, 53, 8, 1882);
    			attr_dev(li9, "class", "svelte-1kc855z");
    			add_location(li9, file$5, 51, 4, 1758);
    			attr_dev(ul, "class", "rating svelte-1kc855z");
    			add_location(ul, file$5, 14, 0, 258);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (61:2) <Button disabled={btnDisabled} type="submit">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(61:2) <Button disabled={btnDisabled} type=\\\"submit\\\">",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-f1fexd");
    			add_location(div, file$4, 63, 4, 1501);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-f1fexd");
    			add_location(h2, file$4, 48, 4, 1078);
    			attr_dev(header, "class", "svelte-f1fexd");
    			add_location(header, file$4, 47, 2, 1065);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell us something that keeps you coming back");
    			attr_dev(input, "class", "svelte-f1fexd");
    			add_location(input, file$4, 54, 2, 1271);
    			attr_dev(div, "class", "input-group svelte-f1fexd");
    			add_location(div, file$4, 53, 2, 1243);
    			add_location(form, file$4, 51, 2, 1143);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const handleInput = () => {
    		if (text.trim().length <= min) {
    			$$invalidate(2, message = `Text must be at least ${min} characters long`);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 18, 2, 445);
    			attr_dev(button, "class", "close svelte-s2w90w");
    			add_location(button, file$3, 21, 2, 500);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$3, 22, 2, 574);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    // (19:0) {#each $FeedbackStore as fb (fb.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$2, 19, 0, 496);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(19:0) {#each $FeedbackStore as fb (fb.id)}",
    		ctx
    	});
    ...
    /* src/components/FeedBackStats.svelte generated by Svelte v3.44.2 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h4 = element("h4");
    			span = element("span");
    			t0 = text(/*average*/ ctx[1]);
    			t1 = text(" Average Rating");
    			set_style(span, "color", "red");
    			add_location(span, file$1, 12, 8, 373);
    			add_location(h4, file$1, 12, 4, 369);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*average*/ 2) set_data_dev(t0, /*average*/ ctx[1]);
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" Average Rating");
    			set_style(span, "color", "red");
    			add_location(span, file$1, 10, 8, 300);
    			add_location(h4, file$1, 10, 4, 296);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h4, anchor);
    			append_dev(h4, span);
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*count*/ ctx[0] === 0) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block.c();
    			set_style(span, "color", "red");
    			add_location(span, file$1, 8, 6, 218);
    			add_location(h4, file$1, 8, 2, 214);
    			attr_dev(div, "class", "feedback-stats svelte-ga2qn0");
    			add_location(div, file$1, 7, 0, 183);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$FeedbackStore, count*/ 5) {
    			$$invalidate(1, average = $FeedbackStore.reduce((acc, cur) => acc + cur.rating, 0) / count);
    		}
    	};

    	return [count, average, $FeedbackStore];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 25, 0, 682);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
